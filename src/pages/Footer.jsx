...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-t from-[#1a1a1a] to-[#333] text-white px-4 py-10 font-[Poppins]">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between text-center md:text-left gap-6">
        <div className="text-base md:text-lg">
          <p className="mb-2">Thank you for visiting my portfolio website.</p>
          <p>Connect with me:</p>
        </div>
        ...
        <div className="text-orange-400 font-semibold text-base md:text-lg">Quick Links</div>
      </div>
